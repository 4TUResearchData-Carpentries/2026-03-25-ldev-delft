...
humandate: "25 - 26 March, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Sreenithya Avadakkam", "Bjørn Bartholdy", "Ben Companjen", "Charles Greene", "Agustin Medina", "Peter Verhaar", "Narmin Rzayeva", "Helena Wedig"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Halford Dace", "Elviss Dvinskis", "Claudia Hernandez Esponda", "Katia Roque Molina" ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "1524903129309"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
